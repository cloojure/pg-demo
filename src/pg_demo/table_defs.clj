  ...
  (into (sorted-map) [
    ...
    { "rm_lm_study_cohorts"
          "CREATE TABLE rm_lm_study_cohorts (
              ...
              BLIND_NAME varchar(999),
              BLIND_NAME_J varchar(999),
    ...
    { "rm_case_master"
          "CREATE TABLE rm_case_master (
              ...
              INITIAL_JUSTIFICATION_J varchar(999),
    ...
    { "rm_case_assess"
          "CREATE TABLE rm_case_assess (
              ...
              SERIOUSNESS numeric,
              SERIOUS_NOTES varchar(999),
              AGENT_SUSPECT numeric,
              AGENT_NOTES varchar(999),
              LISTEDNESS_NOTES varchar(999),
              BFARM_CAUSALITY numeric(10),
              BFARM_MANUAL_TEXT varchar(999),
              COMPANY_DIAGNOSIS varchar(999),
              COMPANY_DIAGNOSIS_NOTES varchar(999),
              DIAGNOSIS_DICT_ID numeric,
              DIAGNOSIS_PREF_CODE varchar(999),
              DIAGNOSIS_INC_CODE varchar(999),
              DIAGNOSIS_INC_TERM varchar(999),
              DIAGNOSIS_HLGT_CODE varchar(999),
              DIAGNOSIS_HLGT varchar(999),
              DIAGNOSIS_HLT_CODE varchar(999),
              DIAGNOSIS_HLT varchar(999),
              DIAGNOSIS_SOC_CODE varchar(999),
              ...
              AGENT_NOTES_J varchar(999),
              COMPANY_DIAGNOSIS_J varchar(999),
              COMPANY_DIAGNOSIS_NOTES_J varchar(999),
              ...
              DIAGNOSIS_INC_CODE_J varchar(999),
              DIAGNOSIS_INC_TERM_J varchar(999),
              DIAGNOSIS_REPTD_J varchar(999),
              LISTEDNESS_NOTES_J varchar(999),
              SERIOUS_NOTES_J varchar(999),
              UD_TEXT_1_J varchar(999),
              UD_TEXT_2_J varchar(999),
              UD_TEXT_3_J varchar(999),
              UD_TEXT_4_J varchar(999),
    ...
    { "rm_case_death"
          "CREATE TABLE rm_case_death (
              ...
              DEATH_DATE_PARTIAL varchar(999),
    ...
    { "rm_case_dose_regimens"
          "CREATE TABLE rm_case_dose_regimens (
              ...
              EXP_DATE_PARTIAL varchar(999),
              START_DATE_PARTIAL varchar(999),
              STOP_DATE_PARTIAL varchar(999),
              DOSE_DESCRIPTION varchar(999),
              PACKAGE_ID varchar(999),
              LOT_NO varchar(999),
              PACK_UNITS numeric,
              ACCIDENTAL_EXPOSURE numeric,
              DELETED timestamp,
              LOT_ID numeric,
              LOT_JUST varchar(999),
    ...
    { "rm_case_eu_device"
          "CREATE TABLE rm_case_eu_device (
              ENTERPRISE_ID numeric NOT NULL,
              CASE_ID numeric NOT NULL,
              ACCESSORIES varchar(999),
              VERSION varchar(999),
              IDENTIFICATION varchar(999),
              PREVIOUSLY_REPORTED numeric,
              INCIDENT numeric,
              COUNTRY varchar(999),
              EXPECTED_DATE timestamp,
              EXPECTED_DATE_RES numeric,
              EXPECTED_DATE_PARTIAL varchar(999),
              ...
              IMPORTER_POSTCODE varchar(999),
              IMPORTER_PHONE varchar(999),
              IMPORTER_FAX varchar(999),
              SEQ_NUM numeric NOT NULL,
              ...
              USER_FAC_REF varchar(999),
              REMEDIAL_ACTION varchar(999),
              DEV_USAGE numeric,
              OTHER varchar(999),
    ...
    { "rm_case_event"
          "CREATE TABLE rm_case_event (
              ...
              ONSET timestamp,
              ONSET_RES numeric,
              ONSET_DELAY varchar(999),
              STOP_DATE timestamp,
              STOP_DATE_RES numeric,
              DURATION varchar(999),
              ONSET_LATENCY varchar(999),
              ...
              SC_INT_REQ numeric,
              SC_OTHER numeric,
              SC_OTHER_TEXT varchar(999),
              ART_CODE varchar(999),
              ...
              PAST_HIST numeric,
              DICT_ID numeric,
              DICT_KEY varchar(999),
              CODE_STATUS numeric,
              SERIOUSNESS numeric,
              SORT_ID numeric,
              ONSET_DATE_PARTIAL varchar(999),
              STOP_DATE_PARTIAL varchar(999),
              EFFICACY numeric,
              DISEASE numeric,
              WITHDRAWAL numeric,
              HLGT varchar(999),
              HLT varchar(999),
              HLT_CODE varchar(999),
              HLGT_CODE varchar(999),
              SOC_CODE varchar(999),
              STUDY_DROPPED numeric(4),
              INC_CODE varchar(999),
              ...
              HLGT_J varchar(999),
              HLT_J varchar(999),
              INC_CODE_J varchar(999),
              INC_TERM_J varchar(999),
              PREF_TERM_J varchar(999),
              SC_OTHER_TEXT_J varchar(999),
              ...
              SYN_CODE_J numeric,
              INFECTION numeric,
              RPT_EXCLUDE_CMT varchar(999),
              RPT_EXCLUDE_CMT_J varchar(999),
              DLP_REVISION_NUMBER numeric NOT NULL,
              REVISION_DELETE_FLAG numeric,
              DELETED_FLAG numeric(1) NOT NULL,
              EFFECTIVE_START_DATE timestamp NOT NULL,
    ...
    { "rm_case_event_assess"
          "CREATE TABLE rm_case_event_assess (
              ...
              LISTED_JUSTIFY varchar(999),
              CAUSE_JUSTIFY varchar(999),
              LAM_ASSESSED numeric(12),
              DELETED timestamp,
              CAUSALITY_ASSESSMENT varchar(999),
              CAUSALITY_SCORE numeric,
              SOURCE_ID numeric,
              PRT_CAUSALITY_ID numeric,
              CAUSE_JUSTIFY_J varchar(999),
              LISTED_JUSTIFY_J varchar(999),
              DLP_REVISION_NUMBER numeric NOT NULL,
              LAST_UPDATE_TIME timestamp,
              REVISION_DELETE_FLAG numeric,
              DELETED_FLAG numeric(1) NOT NULL,
    ...
    { "rm_case_event_imputability"
          "CREATE TABLE rm_case_event_imputability (
              ...
              CHRONOLOGY varchar(999),
              SEMIOLOGY varchar(999),
              BIBLIOGRAPHY varchar(999),
              IMPUTABILITY varchar(999),
              DELETED timestamp,
    ...
    { "rm_case_followup"
          "CREATE TABLE rm_case_followup (
              ...
              JUSTIFICATION varchar(999),
              JUSTIFICATION_ID numeric,
              JUSTIFICATION_J varchar(999),
              JUST_RECEIPT_DATE_J varchar(999),
    ...
    { "rm_case_lab_data"
          "CREATE TABLE rm_case_lab_data (
              ...
              RESULTS varchar(999),
              NORM_HIGH varchar(999),
              NORM_LOW varchar(999),
              TEST_DATE_PARTIAL varchar(999),
              RESULT varchar(999),
              UNIT varchar(999),
              ...
              LLT_CODE_J varchar(999),
              LLT_J varchar(999),
              RESULTS_J varchar(999),
              RESULT_J varchar(999),
              SOC_J varchar(999),
    ...
    { "rm_case_medwatch_data"
          "CREATE TABLE rm_case_medwatch_data (
              ...
              DEV_USAGE numeric,
              DEV_OPER numeric,
              DEV_OPER_OTHER_TEXT varchar(999),
              NDC varchar(999),
              CATALOG varchar(999),
              OTHER varchar(999),
              FACILITY_DISTRIBUTOR numeric(1),
              UF_DIST_REPORT varchar(999),
              NAME_ADDRESS varchar(999),
              CONT_NAME varchar(999),
              CONT_PHONE varchar(999),
              ...
              RS_OTHER_TEXT varchar(999),
              PRE1938 numeric(1),
              OTC numeric(1),
              EVENT_TYPE numeric,
              EVENT_OTHER varchar(999),
              MFR_EVALUATION numeric,
              MFR_NO_CODE varchar(999),
              REMEDIAL_ACTION numeric,
              REMEDIAL_OTHER varchar(999),
              USC varchar(999),
    ...
    { "rm_case_pat_hist"
          "CREATE TABLE rm_case_pat_hist (
              ...
              ITEM_LLT_CODE varchar(999),
              ITEM_HLT_CODE varchar(999),
              ITEM_HLGT_CODE varchar(999),
              ITEM_SOC_CODE varchar(999),
              ...
              IND_PT_CODE varchar(999),
              IND_LLT_CODE varchar(999),
              IND_LLT varchar(999),
              IND_HLT_CODE varchar(999),
              IND_HLT varchar(999),
              IND_HLGT_CODE varchar(999),
              IND_HLGT varchar(999),
              IND_SOC_CODE varchar(999),
              IND_SOC varchar(999),
              ...
              REACT_PT_CODE varchar(999),
              REACT_LLT_CODE varchar(999),
              REACT_LLT varchar(999),
              REACT_HLT_CODE varchar(999),
              REACT_HLT varchar(999),
              REACT_HLGT_CODE varchar(999),
              REACT_HLGT varchar(999),
              REACT_SOC_CODE varchar(999),
    ...
    { "rm_case_pat_info"
          "CREATE TABLE rm_case_pat_info (
              ...
              CASE_ID numeric NOT NULL,
              PAT_ID varchar(999),
              PAT_SUBJ_NUM varchar(999),
              PAT_INITIALS varchar(999),
              PAT_FIRSTNAME varchar(999),
              PAT_MI varchar(999),
              PAT_LASTNAME varchar(999),
              PAT_ADDRESS varchar(999),
              PAT_CITY varchar(999),
              PAT_STATE varchar(999),
              PAT_POSTAL_CODE varchar(999),
              PAT_COUNTRY varchar(999),
              PAT_PHONE varchar(999),
              PAT_DOB timestamp,
              PAT_DOB_RES numeric,
              ...
              REL_TEST_ID numeric,
              PAT_DOB_PARTIAL varchar(999),
              RAND_NUM varchar(999),
              CONFIDENTIAL numeric(1),
              NUMBER_OF_PATIENTS varchar(999),
              UD_TEXT_1 varchar(999),
              UD_TEXT_2 varchar(999),
              UD_TEXT_3 varchar(999),
              UD_TEXT_4 varchar(999),
              ...
              PAT_CITY_J varchar(999),
              PAT_FIRSTNAME_J varchar(999),
              PAT_LASTNAME_J varchar(999),
              PAT_MI_J varchar(999),
              PAT_STATE_J varchar(999),
              UD_TEXT_1_J varchar(999),
              UD_TEXT_2_J varchar(999),
              UD_TEXT_3_J varchar(999),
              UD_TEXT_4_J varchar(999),
    ...
    { "rm_case_pmda_mgmt_num"
          "CREATE TABLE rm_case_pmda_mgmt_num (
              ...
              ACK_BRANCH_NUMBER varchar(999),
              REG_BRANCH_NUMBER varchar(999),
              DELETED timestamp,
              DLP_REVISION_NUMBER numeric NOT NULL,
              REVISION_DELETE_FLAG numeric,
              DELETED_FLAG numeric(1) NOT NULL,
    ...
    { "rm_case_product"
          "CREATE TABLE rm_case_product (
              ...
              QC_CROSS_REFERENCE varchar(999),
              WHO_DRUG_CODE varchar(999),
              CO_DRUG_CODE varchar(999),
              ...
              QC_CROSS_REFERENCE_J varchar(999),
              UD_TEXT_1_J varchar(999),
              UD_TEXT_2_J varchar(999),
              UD_TEXT_3_J varchar(999),
              UD_TEXT_4_J varchar(999),
    ...
    { "rm_case_prod_devices"
          "CREATE TABLE rm_case_prod_devices (
              ...
              CASE_ID numeric NOT NULL,
              SEQ_NUM numeric NOT NULL,
              MODEL_NO varchar(999),
              LOT_NO varchar(999),
              SERIAL_NO varchar(999),
              DATE_IMPLANT timestamp,
              DATE_IMPANT_RES numeric,
              DATE_EXPLANT timestamp,
              DATE_EXPLANT_RES numeric,
              DEVICE_AGE varchar(999),
              EXP_DATE timestamp,
              EXP_DATE_RES numeric,
              SORT_ID numeric,
              EXPLANT_DATE_PARTIAL varchar(999),
              IMPLANT_DATE_PARTIAL varchar(999),
              EXP_DATE_PARTIAL varchar(999),
              DELETED timestamp,
              ...
              DEV_OPER_OTHER_TEXT varchar(999),
              CATALOG varchar(999),
              CATALOG_OTHER varchar(999),
              EVALUATION numeric,
              RETURN_DATE timestamp,
              SUBCOMPONENT_ID numeric,
              SUBCOMPONENT_LOT varchar(999),
              DEVICE_TYPE numeric,
              ...
              UD_NUMBER_12 numeric(30,10),
              FOLLOWUP_TYPE numeric,
              METH_CD1 varchar(999),
              METH_CD2 varchar(999),
              METH_CD3 varchar(999),
              METH_CD4 varchar(999),
              RES_CD1 varchar(999),
              RES_CD2 varchar(999),
              RES_CD3 varchar(999),
              RES_CD4 varchar(999),
              CONC_CD1 varchar(999),
              CONC_CD2 varchar(999),
              CONC_CD3 varchar(999),
              CONC_CD4 varchar(999),
              USC varchar(999),
              MANU_NARRATIVE numeric(1),
              MANU_CORRECTED numeric(1),
              ADVERSE_EVENT numeric,
    ...
    { "rm_case_prod_devices_pmda"
          "CREATE TABLE rm_case_prod_devices_pmda (
              ...
              RESPONSIBLE_OFFICER varchar(999),
    ...
    { "rm_case_prod_drugs"
          "CREATE TABLE rm_case_prod_drugs (
              ...
              FIRST_DOSE_PARTIAL varchar(999),
              LAST_DOSE_PARTIAL varchar(999),
              TAMPERING numeric(4),
              CUMULATIVE_DOSE numeric(22,7),
              CUMULATIVE_DOSE_UNIT varchar(999),
              DELETED timestamp,
              UD_TEXT_1 varchar(999),
              UD_TEXT_2 varchar(999),
              UD_TEXT_3 varchar(999),
    ...
    { "rm_case_prod_qc_cid"
          "CREATE TABLE rm_case_prod_qc_cid (
              ...
              SEQ_NUM numeric NOT NULL,
              SORT_ID numeric,
              CID_NUMBER varchar(999),
              PCID_NUMBER varchar(999),
              LOT_NUMBER varchar(999),
              DELETED timestamp,
              DLP_REVISION_NUMBER numeric NOT NULL,
              EFFECTIVE_START_DATE timestamp NOT NULL,
              EFFECTIVE_END_DATE timestamp NOT NULL,
    ...
    { "rm_case_reporters"
          "CREATE TABLE rm_case_reporters (
              ...
              COUNTRY_ID numeric,
              SUFFIX varchar(999),
              MIDDLE_NAME varchar(999),
              PREFIX varchar(999),
              FIRST_NAME varchar(999),
              LAST_NAME varchar(999),
              REPORTER_ID varchar(999),
              INSTITUTION varchar(999),
              DEPARTMENT varchar(999),
              CITY varchar(999),
              STATE varchar(999),
              POSTCODE varchar(999),
              COUNTRY varchar(999),
              PHONE varchar(999),
              ALTPHONE varchar(999),
              FAX varchar(999),
              REPORTER_REF varchar(999),
              EMAIL varchar(999),
              ADDRESS varchar(999),
              SUFFIX_J varchar(999),
              ADDRESS_J varchar(999),
              CITY_J varchar(999),
              DEPARTMENT_J varchar(999),
              FIRST_NAME_J varchar(999),
              INSTITUTION_J varchar(999),
              LAST_NAME_J varchar(999),
              MIDDLE_NAME_J varchar(999),
              PREFIX_J varchar(999),
              STATE_J varchar(999),
              DELETED timestamp,
              DLP_REVISION_NUMBER numeric NOT NULL,
              REVISION_DELETE_FLAG numeric,
    ...
    { "rm_case_study"
          "CREATE TABLE rm_case_study (
              ...
              CASE_ID numeric NOT NULL,
              STUDY_KEY numeric,
              STUDY_NUM varchar(999),
              STUDY_TYPE numeric,
              CENTER_ID numeric,
              CENTER_NAME varchar(999),
              PROTOCOL_ID numeric,
              PROTOCOL_NUM varchar(999),
              OTHER_ID varchar(999),
              CODE_BROKEN numeric,
              BROKEN_BY numeric,
              ...
              BLIND_NAME_J varchar(999),
              CENTER_NAME_J varchar(999),
              CLIN_COMPOUND_NUM_J varchar(999),
              PROTOCOL_NUM_J varchar(999),
              STUDY_NUM_J varchar(999),
    ...
    { "rm_case_vacc_prior_ae"
          "CREATE TABLE rm_case_vacc_prior_ae (
              ...
              AGE numeric(22,7),
              AGE_UNIT_ID numeric,
              ADVERSE_EVENT varchar(999),
              SORT_ID numeric,
              ADVERSE_EVENT_J varchar(999),
              VACCINE_J varchar(999),
              DELETED timestamp,
              DLP_REVISION_NUMBER numeric NOT NULL,
              REVISION_DELETE_FLAG numeric,
              DELETED_FLAG numeric(1) NOT NULL,
    ...
    { "rm_case_vacc_vaers"
          "CREATE TABLE rm_case_vacc_vaers (
              ...
              CASE_ID numeric NOT NULL,
              VACC_AT_ID numeric,
              VACC_STATE varchar(999),
              VACC_COUNTY varchar(999),
              PURCHASE_ID numeric,
              VACC_ER_VISIT numeric,
              ADMIN_BY varchar(999),
              PHYSICIAN varchar(999),
              FACILITY varchar(999),
              ADDRESS varchar(999),
              CITY varchar(999),
              STATE varchar(999),
              POSTAL_CODE varchar(999),
              PHONE varchar(999),
              RELATION_TO_PATIENT numeric,
              REPORTED_PREVIOUSLY numeric,
              ILLNESS varchar(999),
              VAERS_NUMBER varchar(999),
              PROLONGED_HOSP numeric(1),
              ADDRESS_J varchar(999),
              ADMIN_BY_J varchar(999),
              CITY_J varchar(999),
              FACILITY_J varchar(999),
              ILLNESS_J varchar(999),
              PHYSICIAN_J varchar(999),
              STATE_J varchar(999),
              VACC_COUNTY_J varchar(999),
              VACC_STATE_J varchar(999),
              DELETED timestamp,
              DLP_REVISION_NUMBER numeric NOT NULL,
              REVISION_DELETE_FLAG numeric,
              DELETED_FLAG numeric(1) NOT NULL,
    ...
    { "rm_cfg_dictionaries_global"
          "CREATE TABLE rm_cfg_dictionaries_global (
              NAME varchar(999),
              DIALOG_NUM numeric,
              SQL_DRUG varchar(999),
              SQL_INDICATION varchar(999),
              SQL_EVENT_SIMPLE varchar(999),
              SQL_EVENT_PART1 varchar(999),
              SQL_EVENT_PART2 varchar(999),
              VERSION_NUMBER varchar(999),
              DICTIONARY_SOURCE varchar(999),
              DELETED timestamp,
              SCHEMA_OWNER varchar(999),
              GLOBAL_DICT_ID numeric NOT NULL,
    ...
    { "rm_cfg_groups"
          "CREATE TABLE rm_cfg_groups (
              ENTERPRISE_ID numeric NOT NULL,
              GROUP_ID numeric NOT NULL,
              GROUP_NAME varchar(999),
              EMAIL_ADDR varchar(999),
              CASE_ACCESS varchar(999),
              MENU_ACCESS varchar(999),
              DISABLED numeric,
              LISTEDNESS_ACCESS varchar(999),
    ...
    { "rm_cfg_per_report"
          "CREATE TABLE rm_cfg_per_report (
              ...
              SORT_BY3 numeric,
              GROUP_BY4 numeric,
              TITLE_PER_DRUG varchar(999),
              TITLE_PER_DRUG_OPTION varchar(999),
              REASSESSMENT numeric(3),
              FOOTER varchar(999),
              FDA_SHEETNAME varchar(999),
              FDA_AGENCY_ID numeric,
              SUB_CATEGORY varchar(999),
              SOLICITED_AC_ID numeric,
              SOLICITED_RPT_TITLE varchar(999),
              ...
              JUSTIFICATION_TEXT varchar(999),
    ...
    { "rm_cfg_rpt_wf_states"
          "CREATE TABLE rm_cfg_rpt_wf_states (
              ...
              STATE_NAME varchar(999),
              DELETED timestamp,
              STATE_DESC_J varchar(999),
              STATE_NAME_J varchar(999),
    ...
    { "rm_cfg_users"
          "CREATE TABLE rm_cfg_users (
              ENTERPRISE_ID numeric NOT NULL,
              USER_ID numeric NOT NULL,
              USER_FULLNAME varchar(999),
              USER_NAME varchar(999),
              USER_PASSWORD varchar(999),
    ...
    { "rm_cl_bfarm_causality"
          "CREATE TABLE rm_cl_bfarm_causality (
              ID numeric NOT NULL,
              CAUSALITY varchar(999) NOT NULL,
              DELETED timestamp,
              PRIMARY KEY (ID)
          )" }
    ...
    { "rm_cmn_reg_reports"
          "CREATE TABLE rm_cmn_reg_reports (
              ...
              ESM_REPORT_ID numeric,
              TRACKING_NUM varchar(999),
              EVENT varchar(999),
              BODY_SYS varchar(999),
              STATUS_TEXT varchar(999),
              GENERATION_ERROR varchar(999),
              SUBMIT_NOTES varchar(999),
              NON_SUBMIT_REASON varchar(999),
              DELETED timestamp,
              PROTECT numeric(1),
              COMMENT_TYPE_ID numeric(10),
              REF_TYPE_ID numeric,
              ...
              NULLIFICATION_REASON varchar(999),
    ...
    { "rm_code_list_detail_discrete"
          "CREATE TABLE rm_code_list_detail_discrete (
              ENTERPRISE_ID numeric NOT NULL,
              CODE_LIST_ID varchar(999) NOT NULL,
              DECODE_CONTEXT varchar(999) NOT NULL,
              CODE numeric NOT NULL,
              DISPLAY_VALUE varchar(999),
              PREFERRED numeric(1),
              SORT numeric,
              LAST_UPDATE_TIME timestamp,
    ...
    { "rm_code_list_master"
          "CREATE TABLE rm_code_list_master (
              ENTERPRISE_ID numeric NOT NULL,
              CODE_LIST_ID varchar(999) NOT NULL,
              CODE_LIST_DESC varchar(999),
              SRC_TABLE_NAME varchar(999),
    ...
    { "rm_lm_action_item_type"
          "CREATE TABLE rm_lm_action_item_type (
              ...
              ACTION_TYPE varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              DESCRIPTION varchar(999),
              ...
              USER_GROUP numeric,
              DUE_DAYS numeric,
              LETTER_PLACEHOLDR_CONTENT varchar(999),
              ACTION_TYPE_J varchar(999),
              DESCRIPTION_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_action_taken"
          "CREATE TABLE rm_lm_action_taken (
              ...
              ACTION_TAKEN varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              E2B_CODE numeric,
              ACTION_TAKEN_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_admin_route"
          "CREATE TABLE rm_lm_admin_route (
              ...
              PROTECTED numeric,
              DISPLAY numeric,
              SHORT_NAME varchar(999),
              E2B_CODE varchar(999),
              ROUTE varchar(999) NOT NULL,
              ROUTE_DESC varchar(999),
              ROUTE_DESC_J varchar(999),
              ROUTE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_age_units"
          "CREATE TABLE rm_lm_age_units (
              ...
              AGE_UNIT varchar(999) NOT NULL,
              RELATION numeric,
              PROTECTED numeric,
              DISPLAY numeric,
              E2B_CODE numeric,
              AGE_UNIT_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_always_serious_term"
          "CREATE TABLE rm_lm_always_serious_term (
              ...
              AST_PT_CODE varchar(999),
              AST_PT_TERM varchar(999),
              AST_LLT_CODE varchar(999),
              AST_LLT varchar(999),
              AST_HLT_CODE varchar(999),
              AST_HLT varchar(999),
              AST_HLGT_CODE varchar(999),
              AST_HLGT varchar(999),
              AST_SOC_CODE varchar(999),
              AST_SOC varchar(999),
              CODE_STATUS numeric,
              CODE_DICT numeric,
              DELETED timestamp,
    ...
    { "rm_lm_applications"
          "CREATE TABLE rm_lm_applications (
              APPLICATION_ID numeric NOT NULL,
              APPLICATION_DESC varchar(999) NOT NULL,
              DELETED timestamp,
    ...
    { "rm_lm_birth_type"
          "CREATE TABLE rm_lm_birth_type (
              ...
              BIRTH_TYPE varchar(999) NOT NULL,
              DISPLAY numeric,
              PROTECTED numeric,
              BIRTH_TYPE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_centers"
          "CREATE TABLE rm_lm_centers (
              ...
              CENTER_NO varchar(999),
              CENTER_NAME varchar(999),
              ADDRESS varchar(999),
              CENTER_NAME_J varchar(999),
              CENTER_NO_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_classification"
          "CREATE TABLE rm_lm_classification (
              ENTERPRISE_ID numeric NOT NULL,
              CLASSIFICATION_ID numeric NOT NULL,
              CLASSIFICATION varchar(999) NOT NULL,
              DISPLAY numeric(1),
              PROTECTED numeric(1),
              E2B_ADDITIONAL_DOC numeric,
              CLASSIFICATION_J varchar(999),
              DELETED timestamp,
              PRIMARY KEY (ENTERPRISE_ID,CLASSIFICATION_ID)
          )" }
    ...
    { "rm_lm_clinical_ref_types"
          "CREATE TABLE rm_lm_clinical_ref_types (
              ...
              REF_TYPE_DESC varchar(999),
              REG_NUM_SIZE numeric,
              PROTECTED numeric,
              REF_TYPE_DESC_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_condition_type"
          "CREATE TABLE rm_lm_condition_type (
              ...
              COND_TYPE varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              DELETED timestamp,
              COND_CATEGORY numeric(1),
              COND_TYPE_J varchar(999),
    ...
    { "rm_lm_contact_type"
          "CREATE TABLE rm_lm_contact_type (
              ...
              CONTACT_TYPE varchar(999) NOT NULL,
              DESCRIPTION varchar(999),
              DISPLAY numeric(4) NOT NULL,
              PROTECTED numeric(4) NOT NULL,
              CONTACT_TYPE_J varchar(999),
              DESCRIPTION_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_date_ranges"
          "CREATE TABLE rm_lm_date_ranges (
              ...
              RANGE_NAME varchar(999) NOT NULL,
              DURATION numeric,
              FROM_DATE timestamp,
              TO_DATE timestamp,
              UNITS varchar(999),
              RANGE_NAME_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_delivery_types"
          "CREATE TABLE rm_lm_delivery_types (
              ...
              DELIVERY_TYPE varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              DELIVERY_TYPE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_device_subcomponents"
          "CREATE TABLE rm_lm_device_subcomponents (
              ...
              SUBCOMPONENT_NAME varchar(999),
              DISPLAY numeric,
              PROTECTED numeric,
              SUBCOMPONENT_NAME_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_device_type"
          "CREATE TABLE rm_lm_device_type (
              ...
              DEVICE_TYPE_DESC varchar(999) NOT NULL,
              DISPLAY numeric,
              PROTECTED numeric,
              DEVICE_TYPE_DESC_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_dev_phase"
          "CREATE TABLE rm_lm_dev_phase (
              ...
              DEV_PHASE varchar(999),
              DEV_PHASE_J varchar(999),
              E2B_CODE numeric(2),
              DISPLAY numeric(1),
              PROTECTED numeric(1),
              DELETED timestamp,
    ...
    { "rm_lm_emperor"
          "CREATE TABLE rm_lm_emperor (
              ...
              EMPEROR_NAME varchar(999),
              EMPEROR_NAME_J varchar(999),
              OFFICE_DATE_J timestamp,
              DISPLAY numeric(1),
              PROTECTED numeric(1),
              DATE_ENTRY_ABBREV varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_ethnicity"
          "CREATE TABLE rm_lm_ethnicity (
              ...
              ETHNICITY varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              ETHNICITY_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_evaluator_type"
          "CREATE TABLE rm_lm_evaluator_type (
              ENTERPRISE_ID numeric NOT NULL,
              EVALUATOR_TYPE_ID numeric NOT NULL,
              EVALUATOR_TYPE varchar(999) NOT NULL,
              SITE_ID numeric,
              EVALUATOR_TYPE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_evt_frequency"
          "CREATE TABLE rm_lm_evt_frequency (
              ...
              EVT_FREQ varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              EVT_FREQ_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_evt_intensity"
          "CREATE TABLE rm_lm_evt_intensity (
              ...
              EVT_INTENSITY varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              EVT_INTENSITY_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_evt_nature"
          "CREATE TABLE rm_lm_evt_nature (
              ENTERPRISE_ID numeric NOT NULL,
              EVT_NATURE_ID numeric NOT NULL,
              EVT_NATURE varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              EVT_NATURE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_evt_outcome"
          "CREATE TABLE rm_lm_evt_outcome (
              ...
              EVT_OUTCOME varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              E2B_CODE numeric,
              EVT_OUTCOME_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_failure_code"
          "CREATE TABLE rm_lm_failure_code (
              ENTERPRISE_ID numeric NOT NULL,
              FAILURE_CD varchar(999) NOT NULL,
              FAILURE_DESC varchar(999),
              FAILURE_CD_TYPE varchar(999),
              FAILURE_CD_GROUP varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_fetal_outcome"
          "CREATE TABLE rm_lm_fetal_outcome (
              ...
              FETAL_OUTCOME varchar(999) NOT NULL,
              DISPLAY numeric,
              PROTECTED numeric,
              FETAL_OUTCOME_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_formulation"
          "CREATE TABLE rm_lm_formulation (
              ...
              FORMULATION_SYMBOL_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_improper_use"
          "CREATE TABLE rm_lm_improper_use (
              ...
              IMPROPER_USE varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              IMPROPER_USE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_intermediary"
          "CREATE TABLE rm_lm_intermediary (
              ...
              INTERMEDIARY varchar(999) NOT NULL,
              PROTECTED numeric,
              INTERMEDIARY_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_labeled_terms"
          "CREATE TABLE rm_lm_labeled_terms (
              ...
              TERM_LLT_CODE varchar(999),
              TERM_HLT_CODE varchar(999),
              TERM_HLGT_CODE varchar(999),
              TERM_SOC_CODE varchar(999),
    ...
    { "rm_lm_lab_assessment"
          "CREATE TABLE rm_lm_lab_assessment (
              ...
              ASSESSMENT varchar(999) NOT NULL,
              DISPLAY numeric(1),
              PROTECTED numeric(1),
              ASSESSMENT_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_lab_test_types"
          "CREATE TABLE rm_lm_lab_test_types (
              ...
              TEST_LLT_CODE varchar(999),
              TEST_PT_CODE varchar(999),
              TEST_HLT_CODE varchar(999),
              TEST_HLGT_CODE varchar(999),
              TEST_SOC_CODE varchar(999),
              DELETED timestamp,
              CODE_STATUS numeric,
              CODE_DICT numeric,
    ...
    { "rm_lm_license"
          "CREATE TABLE rm_lm_license (
              ...
              CTPR_GROUP_NAME varchar(999),
              COMMENTS varchar(999),
              MHLW_RE_EXAMINATION_DATE timestamp,
              CLINICAL_COMPOUND_NUMBER varchar(999),
              TRADE_NAME_J varchar(999),
              COMMENTS_J varchar(999),
    ...
    { "rm_lm_license_types"
          "CREATE TABLE rm_lm_license_types (
              ...
              LICENSE_TYPE varchar(999),
              LICENSE_TYPE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_listedness"
          "CREATE TABLE rm_lm_listedness (
              ...
              LISTEDNESS varchar(999),
              PROTECTED numeric,
              DISPLAY numeric,
              DELETED timestamp,
              LABELEDNESS varchar(999),
              LABELEDNESS_J varchar(999),
              LISTEDNESS_J varchar(999),
    ...
    { "rm_lm_location"
          "CREATE TABLE rm_lm_location (
              ...
              LOCATION_DESC varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              LOCATION_DESC_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_manufacturer"
          "CREATE TABLE rm_lm_manufacturer (
              ...
              MANU_NAME varchar(999) NOT NULL,
              ADDRESS varchar(999),
              CITY varchar(999),
              STATE varchar(999),
              POSTAL_CODE varchar(999),
              ...
              ADDRESS_J varchar(999),
              CITY_J varchar(999),
              CONTACT_J varchar(999),
              MANU_NAME_J varchar(999),
              STATE_J varchar(999),
    ...
    { "rm_lm_product"
          "CREATE TABLE rm_lm_product (
              ENTERPRISE_ID numeric NOT NULL,
              PRODUCT_ID numeric NOT NULL,
              PROD_NAME varchar(999),
              FAMILY_ID numeric,
              FORMULATION_ID numeric,
              MANUFACTURER_ID numeric,
              CONCENTRATION varchar(999),
              CONC_UNIT_ID numeric,
              INDICATION_ID varchar(999),
              CODE_DICT numeric,
              ...
              MEDICINAL_PROD_ID varchar(999),
              PROD_NAME_ABBRV varchar(999),
              DEVICE_CODE varchar(999),
              PSUR_GROUP_NAME varchar(999),
              COMMENTS varchar(999),
              IND_CODED varchar(999),
              IND_REPTD varchar(999),
              DRL_ID_J varchar(999),
              DRUG_CODE_J varchar(999),
              DRUG_CODE_TYPE_J numeric,
    ...
    { "rm_lm_product_family"
          "CREATE TABLE rm_lm_product_family (
              ...
              PRODUCT_GROUP_ID numeric,
              COMMENTS varchar(999),
              SEARCH_EQUATION_NUMBER varchar(999),
              NAME_J varchar(999),
              COMMENTS_J varchar(999),
    ...
    { "rm_lm_product_lots"
          "CREATE TABLE rm_lm_product_lots (
              ...
              PRODUCT_ID numeric NOT NULL,
              LOT_NO varchar(999),
              EXT_LOT_ID varchar(999),
              EXPIRATION_DATE timestamp,
              EXPIRATION_DATE_RES numeric,
              EXPIRATION_DATE_PARTIAL varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_protocols"
          "CREATE TABLE rm_lm_protocols (
              ...
              PROTOCOL_DESC varchar(999),
              DELETED timestamp,
              DISPLAY numeric,
              PROTOCOL_DESC_J varchar(999),
    ...
    { "rm_lm_purchased_with"
          "CREATE TABLE rm_lm_purchased_with (
              ...
              PURCHASE varchar(999),
              PURCHASE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_ref_types"
          "CREATE TABLE rm_lm_ref_types (
              ENTERPRISE_ID numeric NOT NULL,
              REF_TYPE_ID numeric NOT NULL,
              TYPE_DESC varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              TYPE_DESC_J varchar(999),
              DELETED timestamp,
              PRIMARY KEY (ENTERPRISE_ID,REF_TYPE_ID)
          )" }
    ...
    { "rm_lm_regulatory_contact"
          "CREATE TABLE rm_lm_regulatory_contact (
              ...
              AGENCY_NAME varchar(999),
              REG_NUM varchar(999),
              CONTACT_NAME varchar(999),
              TITLE varchar(999),
              ADDRESS varchar(999),
              CITY varchar(999),
              STATE varchar(999),
              POST_CODE varchar(999),
              COUNTRY numeric,
              PHONE varchar(999),
              FAX varchar(999),
              EMAIL varchar(999),
              ...
              MIDDLE_NAME varchar(999),
              TEL_EXT varchar(999),
              TEL_CONT_CODE varchar(999),
              FAX_EXT varchar(999),
              FAX_CONT_CODE varchar(999),
              MAX_E2B_RPT numeric,
              VIEW_PRINT_METHOD numeric,
              RECEIVER_TYPE numeric,
              SENDER_TYPE numeric,
              CONT_COUNTRY_ID numeric,
              CONT_COMPANY_NAME varchar(999),
              CONT_NAME varchar(999),
              CONT_TITLE varchar(999),
              CONT_ADDRESS varchar(999),
              CONT_CITY varchar(999),
              CONT_STATE varchar(999),
              CONT_POSTCODE varchar(999),
              CONT_PHONE varchar(999),
              CONT_FAX varchar(999),
              CONT_DEPARTMENT varchar(999),
              CONT_FIRST_NAME varchar(999),
              CONT_MIDDLE_NAME varchar(999),
              CONT_TEL_EXT varchar(999),
              CONT_TEL_CONT_CODE varchar(999),
              CONT_FAX_EXT varchar(999),
              CONT_FAX_CONT_CODE varchar(999),
              SENDER_EMAIL varchar(999),
              FAX_MAIN varchar(999),
              ...
              USE_JPN_AWARE_DATE varchar(999),
              MULT_RPT_MKT_DRUGS varchar(999),
              MULT_RPT_INVEST_DRUGS varchar(999),
              ADJUST_DUE_DT_FOR_HOLIDAYS numeric(1),
              AGENCY_NAME_J varchar(999),
              CONT_COMPANY_NAME_J varchar(999),
    ...
    { "rm_lm_reporter_type"
          "CREATE TABLE rm_lm_reporter_type (
              ...
              REPORTER_TYPE varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              E2B_CODE numeric,
              REPORTER_TYPE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_report_type"
          "CREATE TABLE rm_lm_report_type (
              ...
              REPORT_TYPE varchar(999) NOT NULL,
              PROTECTED numeric,
              DISPLAY numeric,
              INCL_LIT numeric,
              INCL_TRIAL numeric,
    ...
    { "rm_lm_sites"
          "CREATE TABLE rm_lm_sites (
              ENTERPRISE_ID numeric NOT NULL,
              SITE_ID numeric NOT NULL,
              SITE_DESC varchar(999),
              SITE_ABRV varchar(999),
              DELETED timestamp,
              LAM_SITE numeric,
    ...
    { "rm_lm_studies"
          "CREATE TABLE rm_lm_studies (
              ...
              STUDY_NUM varchar(999),
              PROTOCOL_NUM varchar(999),
              OTHER_NUM varchar(999),
              STUDY_TYPE numeric,
              UNBLIND_OK numeric(1),
              ENCODING numeric(4),
              DRUG_AUTO numeric(4),
              DRUG_DICT varchar(999),
              EVENT_AUTO numeric(4),
              EVENT_DICT varchar(999),
    ...
    { "rm_lm_study_types"
          "CREATE TABLE rm_lm_study_types (
              STUDY_TYPE_ID numeric NOT NULL,
              STUDY_TYPE varchar(999),
              PROTECTED numeric,
              DISPLAY numeric,
              STUDY_TYPE_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_lm_unblinding_status"
          "CREATE TABLE rm_lm_unblinding_status (
              ENTERPRISE_ID numeric NOT NULL,
              STATUS_ID numeric NOT NULL,
              UNBLINDING_STATUS varchar(999),
              DISPLAY numeric(1),
              PROTECTED numeric(1),
              UNBLINDING_STATUS_J varchar(999),
              DELETED timestamp,
              PRIMARY KEY (ENTERPRISE_ID,STATUS_ID)
          )" }
    ...
    { "rm_lm_vaers_rpt_block"
          "CREATE TABLE rm_lm_vaers_rpt_block (
              ...
              BLOCK_NAME varchar(999),
              BLOCK_NAME_J varchar(999),
              DELETED timestamp,
    ...
    { "rm_meddra_hlg_pref_term"
          "CREATE TABLE rm_meddra_hlg_pref_term (
              ...
              HLGT_WHO_ART_CODE varchar(999),
              HLGT_HARTS_CODE numeric,
              HLGT_COSTART_FG varchar(999),
              HLGT_ICD9_CODE varchar(999),
              HLGT_ICD9CM_CODE varchar(999),
              HLGT_ICD10_CODE varchar(999),
              HLGT_J_ART_CODE varchar(999),
              DELETED timestamp,
    ...
    { "rm_meddra_hl_pref_term"
          "CREATE TABLE rm_meddra_hl_pref_term (
              ...
              HLT_WHO_ART_CODE varchar(999),
              HLT_HARTS_CODE numeric,
              HLT_COSTART_FG varchar(999),
              HLT_ICD9_CODE varchar(999),
              HLT_ICD9CM_CODE varchar(999),
              HLT_ICD10_CODE varchar(999),
              HLT_J_ART_CODE varchar(999),
              DELETED timestamp,
    ...
    { "rm_meddra_md_hierarchy"
          "CREATE TABLE rm_meddra_md_hierarchy (
              ...
              SOC_ABBREV varchar(999) NOT NULL,
              NULL_FIELD varchar(999),
              PT_SOC_CODE numeric,
              PRIMARY_SOC_FG varchar(999),
              DELETED timestamp,
    ...
    { "rm_meddra_pref_term"
          "CREATE TABLE rm_meddra_pref_term (
              ...
              NULL_FIELD varchar(999),
              PT_SOC_CODE numeric,
              PT_WHO_ART_CODE varchar(999),
              PT_HARTS_CODE numeric,
              PT_COSTART_FG varchar(999),
              PT_ICD9_CODE varchar(999),
              PT_ICD9CM_CODE varchar(999),
              PT_ICD10_CODE varchar(999),
              PT_J_ART_CODE varchar(999),
              DELETED timestamp,
    ...
    { "rm_meddra_pref_term_llt"
          "CREATE TABLE rm_meddra_pref_term_llt (
              ...
              PT_CODE numeric,
              LLT_WHO_ART_CODE varchar(999),
              LLT_HARTS_CODE numeric,
              LLT_COSTART_FG varchar(999),
              LLT_ICD9_CODE varchar(999),
              LLT_ICD9CM_CODE varchar(999),
              LLT_ICD10_CODE varchar(999),
              LLT_CURRENCY varchar(999),
              LLT_J_ART_CODE varchar(999),
              DELETED timestamp,
    ...
    { "rm_meddra_smq_content"
          "CREATE TABLE rm_meddra_smq_content (
              ...
              TERM_CATEGORY varchar(999) NOT NULL,
              TERM_WEIGHT numeric NOT NULL,
              TERM_STATUS varchar(999) NOT NULL,
              TERM_ADDITION_VERSION varchar(999) NOT NULL,
              TERM_LAST_MODIFIED_VERSION varchar(999) NOT NULL,
    ...
    { "rm_meddra_smq_list"
          "CREATE TABLE rm_meddra_smq_list (
              ...
              SMQ_DESCRIPTION varchar(999),
              SMQ_SOURCE varchar(999),
              SMQ_NOTE varchar(999),
              MEDDRA_VERSION varchar(999) NOT NULL,
    ...
    { "rm_meddra_smq_term_details"
          "CREATE TABLE rm_meddra_smq_term_details (
              ...
              TERM_LEVEL numeric,
              TERM_SCOPE numeric,
              TERM_CATEGORY varchar(999),
              TERM_WEIGHT numeric,
              TERM_STATUS varchar(999),
              TERM_NAME_ENGLISH varchar(999),
              LLT_CURRENCY varchar(999),
              TERM_ADDITION_VERSION varchar(999),
              TERM_LAST_MODIFIED_VERSION varchar(999),
              CREATE_DATE timestamp,
    ...
    { "rm_meddra_soc"
          "CREATE TABLE rm_meddra_soc (
              ...
              SOC_ABBREV varchar(999) NOT NULL,
              SOC_WHO_ART_CODE varchar(999),
              SOC_HARTS_CODE numeric,
              SOC_COSTART_FG varchar(999),
              SOC_ICD9_CODE varchar(999),
              SOC_ICD9CM_CODE varchar(999),
              SOC_ICD10_CODE varchar(999),
              SOC_J_ART_CODE varchar(999),
              DELETED timestamp,
    ...
    { "rm_meddra_spec_cat"
          "CREATE TABLE rm_meddra_spec_cat (
              ...
              SPEC_ABBREV varchar(999) NOT NULL,
              DELETED timestamp
          )" }
    ...
    { "rm_who_atc_classification"
          "CREATE TABLE rm_who_atc_classification (
              GLOBAL_DICT_ID numeric NOT NULL,
              DRUG_RECORD_NUMBER varchar(999) NOT NULL,
              SEQ_NUM1 varchar(999) NOT NULL,
              SEQ_NUM2 varchar(999) NOT NULL,
              CHECK_DIGIT varchar(999) NOT NULL,
              ATC_CODE varchar(999) NOT NULL,
              YEAR_QUARTER varchar(999),
              OFFICIAL_ATC_CODE varchar(999),
              DELETED timestamp,
    ...
    { "rm_who_drug_c_country"
          "CREATE TABLE rm_who_drug_c_country (
              GLOBAL_DICT_ID numeric NOT NULL,
              COUNTRY_CODE varchar(999) NOT NULL,
              COUNTRY_NAME varchar(999),
              PRIMARY KEY (GLOBAL_DICT_ID,COUNTRY_CODE)
          )" }
    ...
    { "rm_who_drug_c_ingredients"
          "CREATE TABLE rm_who_drug_c_ingredients (
              GLOBAL_DICT_ID numeric NOT NULL,
              INGREDIENT_ID varchar(999) NOT NULL,
              CREATE_DATE varchar(999),
              SUBSTANCE_ID varchar(999),
              QUANTITY varchar(999),
              QUANTITY_2 varchar(999),
              UNIT varchar(999),
              PHARM_PRODUCT_ID varchar(999),
              MEDICINAL_PROD_ID varchar(999),
    ...
    { "rm_who_drug_c_master"
          "CREATE TABLE rm_who_drug_c_master (
              ...
              MEDICINAL_PROD_ID varchar(999) NOT NULL,
              DRUG_RECORD_NUMBER varchar(999),
              SEQ_NUM1 varchar(999),
              SEQ_NUM2 varchar(999),
              CODE varchar(999),
              PROD_TYPE_ID varchar(999),
              DRUG_NAME varchar(999),
              SUBSTANCE_NAME varchar(999),
              MANU_NAME varchar(999),
              COUNTRY varchar(999),
              PHARM_FORM_ID varchar(999),
              FORMULATION varchar(999),
              STRENGTH_ID varchar(999),
              STRENGTH varchar(999),
              GENERIC varchar(999),
              ATC_CODE varchar(999),
              ATC_TEXT varchar(999),
              NAME_SPECIFIER varchar(999),
    ...
    { "rm_who_drug_c_medicinal_prod"
          "CREATE TABLE rm_who_drug_c_medicinal_prod (
              GLOBAL_DICT_ID numeric NOT NULL,
              MEDICINAL_PROD_ID varchar(999) NOT NULL,
              ICH_MEDICINAL_PROD_ID varchar(999),
              DRUG_RECORD_NUMBER varchar(999),
              SEQ_NUM1 varchar(999),
              SEQ_NUM2 varchar(999),
              SEQ_NUM3 varchar(999),
              SEQ_NUM4 varchar(999),
              GENERIC varchar(999),
              DRUG_NAME varchar(999),
              NAME_SPECIFIER varchar(999),
              MA_NUMBER varchar(999),
              MA_DATE varchar(999),
              MA_WITHDRAW_DATE varchar(999),
              COUNTRY varchar(999),
              COMPANY varchar(999),
              MA_HOLDER varchar(999),
              SOURCE_CODE varchar(999),
              SOURCE_COUNTRY varchar(999),
              SOURCE_YEAR varchar(999),
              PRODUCT_TYPE varchar(999),
              PRODUCT_GROUP varchar(999),
              CREATE_DATE varchar(999),
              DATE_CHANGED varchar(999),
    ...
    { "rm_who_drug_c_organization"
          "CREATE TABLE rm_who_drug_c_organization (
              GLOBAL_DICT_ID numeric NOT NULL,
              ORGANIZATION_ID varchar(999) NOT NULL,
              NAME varchar(999),
              COUNTRY_CODE varchar(999),
    ...
    { "rm_who_drug_c_pharma_form"
          "CREATE TABLE rm_who_drug_c_pharma_form (
              GLOBAL_DICT_ID numeric NOT NULL,
              PHARM_FORM_ID varchar(999) NOT NULL,
              TEXT varchar(999),
    ...
    { "rm_who_drug_c_pharma_product"
          "CREATE TABLE rm_who_drug_c_pharma_product (
              GLOBAL_DICT_ID numeric NOT NULL,
              PHARM_PRODUCT_ID varchar(999) NOT NULL,
              PHARMACEUTICAL_FORM varchar(999),
              ROUTE_OF_ADMIN varchar(999),
              MEDICINAL_PROD_ID varchar(999),
              NUMBER_OF_INGREDIENTS varchar(999),
              CREATE_DATE varchar(999),
    ...
    { "rm_who_drug_c_product_group"
          "CREATE TABLE rm_who_drug_c_product_group (
              GLOBAL_DICT_ID numeric NOT NULL,
              PRODUCT_GROUP_ID varchar(999) NOT NULL,
              PRODUCT_GROUP_NAME varchar(999),
              DATE_RECORDED varchar(999),
    ...
    { "rm_who_drug_c_product_type"
          "CREATE TABLE rm_who_drug_c_product_type (
              GLOBAL_DICT_ID numeric NOT NULL,
              PROD_TYPE_ID varchar(999) NOT NULL,
              TEXT varchar(999),
    ...
    { "rm_who_drug_c_source"
          "CREATE TABLE rm_who_drug_c_source (
              GLOBAL_DICT_ID numeric NOT NULL,
              SOURCE_CODE varchar(999) NOT NULL,
              SOURCE varchar(999),
              COUNTRY_CODE varchar(999),
    ...
    { "rm_who_drug_c_strength"
          "CREATE TABLE rm_who_drug_c_strength (
              GLOBAL_DICT_ID numeric NOT NULL,
              STRENGTH_ID varchar(999) NOT NULL,
              TEXT varchar(999),
    ...
    { "rm_who_drug_c_substance"
          "CREATE TABLE rm_who_drug_c_substance (
              GLOBAL_DICT_ID numeric NOT NULL,
              SUBSTANCE_ID varchar(999) NOT NULL,
              CAS_NUMBER varchar(999),
              LANGUAGE_CODE varchar(999),
              SUBSTANCE_NAME varchar(999),
              SOURCE_YEAR varchar(999),
              SOURCE_CODE varchar(999),
    ...
    { "rm_who_drug_c_therapeutic_grp"
          "CREATE TABLE rm_who_drug_c_therapeutic_grp (
              GLOBAL_DICT_ID numeric NOT NULL,
              THERAP_GROUP_ID varchar(999) NOT NULL,
              ATC_CODE varchar(999),
              CREATE_DATE varchar(999),
              OFFICIAL_ATC_CODE varchar(999),
              MEDICINAL_PROD_ID varchar(999),
